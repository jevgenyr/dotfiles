...
osascript -e "tell application \"System Events\" to set picture of every desktop to \"/Users/kiasaki/dotfiles/conf/wallpaper.jpg\""
...
open "${HOME}/dotfiles/conf/solarized.itermcolors"
