...
osascript -e "tell application \"System Events\" to set picture of every desktop to \"$HOME/dotfiles/support/wallpaper.jpg\""
...
# Install the Smyck theme for iTerm
open "${HOME}/dotfiles/colors/smyck.itermcolors"
